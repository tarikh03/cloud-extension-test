...
public class WSExecute implements Runnable{
    protected static Log log = Log.a(WSExecute.class);
	private String URL;
    ...
    public static String fnInvokeWS(String reqMethod, String URL, String reqBody, Map<String, String> reqMap, Integer reqConnTOInMS, Integer reqReadTOInMS) throws Exception {
        ...
        try {
            ...
            if(reqMap != null) {
                for(java.util.Map.Entry<String, String> mapEnt : reqMap.entrySet()) {
